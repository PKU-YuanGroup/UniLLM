    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            if self.args.llm_lr is not None:
                lm_parameters = [
                    name for name, _ in optimized_parameters if "vision_model" not in name and "aligner" not in name and "gen_aligner" not in name and "gen_head" not in name and "gen_embed" not in name
                ]
            ...
            if self.args.vision_encoder_lr is not None:
                vision_encoder_parameters = [name for name, _ in optimized_parameters if "vision_model" in name]
