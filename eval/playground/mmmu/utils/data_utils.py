...
def process_single_sample(data):
    ...
    images=[data['image_1']]
    for idx in o_imgs_paths:
        if idx!='1':
            images.append(data['image_'+idx])
    return {'id': data['id'], 'question': question, 'options': options, 'answer': data['answer'],
...
def construct_prompt(sample, config):
    ...
    return res_dict['final_input_prompt'],res_dict