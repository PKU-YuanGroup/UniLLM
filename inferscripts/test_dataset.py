...
from train_files.dataset_files.image_gen_dataset import ImageGenDataset
from train_files.dataset_files.image_under_dataset import ImageUnderDataset
from train_files.dataset_files.text_chat_dataset  import TextChatDataset
...
vlprocessor.tokenizer_model_max_length = 700
vlprocessor.use_tokenizer_truncation =  True
