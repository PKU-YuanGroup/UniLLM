...
def _run_eval() -> None:
    ...
    for filepath in filepaths:
        ...
        image = read_image(filepath) # shape=(816, 1920, 3), dtype=uint8)
        image = resize_image(image, short_size=args.short_size) # shape=(816, 1920, 3), dtype=uint8)
        batch_image = np.expand_dims(image, axis=0) #  shape=(1, 816, 1920, 3), dtype=uint8)
