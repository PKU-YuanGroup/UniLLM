...
# ============================================
MAX_MASK_RATIO=$4
OUTP_DIR=checkpoints/stage1_2scale_192_384_sdpa_ft_attnmask_random_replace_$MAX_MASK_RATIO
...
torchrun --nnodes $WORLD_SIZE \
    ...
    --ar_with_non_ar True \
    --is_causal False \
    --only_compute_ar_loss False \
    --_attn_implementation_new  "sdpa"  \
    --scale_list "12,24"  \
    --visual_token_replace_max_ratio  $MAX_MASK_RATIO
