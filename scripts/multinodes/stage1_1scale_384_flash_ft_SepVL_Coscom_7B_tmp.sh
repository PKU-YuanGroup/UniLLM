...
OUTP_DIR=checkpoints/stage1_1scale_384_flash_ft_SepVL_Cosmos_tmp0323
...
torchrun --nnodes $WORLD_SIZE \
    ...
    --model_path /storage/zhubin/Janus-MoE/pretrained_ckpts/Janus-Pro-7B \
