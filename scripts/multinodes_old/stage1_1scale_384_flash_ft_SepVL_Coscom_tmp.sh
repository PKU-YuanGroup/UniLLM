...
torchrun --nnodes $WORLD_SIZE \
    ...
    --image_under_data_files /mnt/data/unify_data/img_data/BAAI/DenseFusion-1M/DenseFusion-4V-100k/mini_uni_DenseFusion-4V-100k.json \
    --image_under_rootdir /mnt/data/unify_data/img_data/BAAI/DenseFusion-1M/images \
    ...
    --text_chat_data_files /mnt/data/unify_data/img_data/BAAI/Infinity-Instruct/uni_Gen.json   \
